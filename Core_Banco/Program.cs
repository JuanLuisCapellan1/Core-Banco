...
builder.Services.AddDbContext<Core_BancoContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("Core_BancoContext") ?? throw new InvalidOperationException("Connection string 'Core_BancoContext' not found.")));
